...
var Utils = {
  ...
  checkParamKeyEmpty: function checkParamKeyEmpty(c, b) {
    if (!c[b]) {
      var a = this.buildErrorConfig(
        ERROR_CONF.PARAM_ERR,
        ERROR_CONF.PARAM_ERR_MSG + b + "参数格式有误"
      );
      c.fail(a);
      c.complete(a);
      return true;
  ...
  buildWxRequestConfig: function buildWxRequestConfig(c, a) {
    ...
    a.complete = function (d) {
      ...
      switch (e) {
        ...
        default:
          c.complete(
            b.buildErrorConfig(ERROR_CONF.SYSTEM_ERR, ERROR_CONF.SYSTEM_ERR_MSG)
          );
      }
    };
    return a;
  ...
  _createClass(b, [
      ...
      value: function f(i) {
        ...
        var m = function m(o) {
          k.boundary =
            ...
            ")";
          wx.request(
            Utils.buildWxRequestConfig(i, { url: URL_SEARCH, data: k })
          );
        };
    ...
    },
    {
      ...
      value: function h(i) {
        ...
        wx.request(
          Utils.buildWxRequestConfig(i, { url: URL_SUGGESTION, data: j })
        );
      },
    },
    {
      ...
      value: function a(i) {
        ...
        var l = function l(m) {
          ...
          wx.request(
            Utils.buildWxRequestConfig(i, { url: URL_GET_GEOCODER, data: j })
          );
        };
    ...
    },
    {
      ...
      value: function c(i) {
        ...
        wx.request(
          Utils.buildWxRequestConfig(i, { url: URL_CITY_LIST, data: j })
        );
      },
    },
    {
      ...
      value: function d(i) {
        ...
        wx.request(
          Utils.buildWxRequestConfig(i, { url: URL_AREA_LIST, data: j })
        );
      },
    },
    {
      ...
      value: function e(i) {
        ...
        var l = function l(m) {
          ...
          wx.request(
            Utils.buildWxRequestConfig(i, { url: URL_DISTANCE, data: j })
          );
        };
        if (i.from) {
          i.location = i.from;
